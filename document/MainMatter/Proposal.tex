...
\textbf{Resultaron interesantes los siguientes lugares para representar:}
\begin{enumerate}
...
El proceso de $fuzzificación$ es distinto para concepto, pero por regla general se sigue la siguiente idea:\\
\begin{enumerate}
